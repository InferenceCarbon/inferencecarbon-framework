...
| `tables_7_to_10.py` | the deposited workbook | every paper table as CSV; optional cell-by-cell check of a paper .docx (`--paper`) | ~5 s |
...
python tables_7_to_10.py --workbook out/recalc/regen.xlsx --out out/tables && diff -r out/tables expected/tables
```
